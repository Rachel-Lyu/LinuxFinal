...
class App(QWidget):
    ...
    def initUI(self):
        ...
        self.fileButton.setGeometry(201*self.scale, 252*self.scale, 5, 50)
        ...
        self.label.setGeometry(50*self.scale, 440*self.scale, 300, 50)
        ...
        self.label2.setGeometry(68*self.scale, 140*self.scale, 150, 50)
        self.comboBox = QComboBox(self)
        self.comboBox.addItem("HandWriting")
        self.comboBox.addItem("Photograph")
        self.comboBox.move(70*self.scale, 180*self.scale)
        self.comboBox.setFont(font)
        self.text = QLineEdit(self)
        self.text.setGeometry(35*self.scale, 250*self.scale, 330, 60)
        self.openButton = QPushButton('Open', self)
        self.openButton.move(110*self.scale, 320*self.scale)
